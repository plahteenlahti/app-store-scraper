...
var iTunesAppResponseSchema = z.object({
...
var iTunesLookupResponseSchema = z.object({
  resultCount: z.number(),
  results: z.array(iTunesAppResponseSchema)
});
var rssFeedEntrySchema = z.object({
  id: z.object({
    attributes: z.object({
...
var rssFeedSchema = z.object({
  feed: z.object({
    entry: z.array(rssFeedEntrySchema).optional()
  }).optional()
});
var reviewEntrySchema = z.object({
  author: z.object({
    uri: z.object({
...
var privacyTypeSchema = z.object({
...
var privacyDetailsSchema = z.object({
...
var versionHistoryEntrySchema = z.object({
